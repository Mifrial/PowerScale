...
### Навык: Тренировка воли · Стоимость 2, 2, 3, 3, 3, 4
  Вы получаете +{уровень навыка} к Силе воли от тренировки.
...
### Действие(1ОД): Стремительный удар · Стоимость 2
- Требование: Реакция 3 большая, навык Быстрый удар
  ...
  *Признаки: навык, действие, подготовка, ближний бой*
