...
27. **Редактор правил: полный спектр + обязательные поля** — убедиться, что в UI можно корректно править все доступные настройки существующих типов правил и что сохранение требует обязательные поля (как склонения типа урона).
28. **Деталки правил** — страница и слайдер: структурированно вся информация по правилу, удобно читать (сейчас беднее блоков в редакторе персонажа). Критерий: не заглядывать в редактор, чтобы понять правило. Поможет при приведении каталога к реальному виду.
