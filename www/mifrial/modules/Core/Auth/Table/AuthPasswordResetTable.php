...
/**
 * Карта одноразового токена сброса пароля.
 */
final class AuthPasswordResetTable extends SmartTableDefinition
{
    /**
    ...
    protected function defineFields(): array
    {
        return [
            ...
            new DateTimeField('used_at', FieldSettings::fromOptions([])),
        ];
    }
}
