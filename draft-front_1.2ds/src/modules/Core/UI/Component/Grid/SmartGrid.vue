...
.smart-grid .smart-header-th--resizing,
.smart-grid .smart-header-th--resizing * {
  cursor: col-resize;
  user-select: none;
}
...
.smart-grid .smart-header-th--settings {
  border-right: thin solid rgba(var(--v-border-color), var(--v-border-opacity));
  width: 1%;
  padding: 0 4px;
  text-align: center;
...
.smart-grid .smart-cell--settings {
  width: 1%;
  padding: 0;
  text-align: center;
}
...
.smart-grid .smart-cell--settings .smart-burger-icon:hover {
  opacity: 1;
}
