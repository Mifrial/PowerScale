...
const { earsLeft, earsRight, updateEars, scroll, initEars, cleanup } = useScrollEars({
  scrollContainer,
  scrollSelector: props.scrollSelector,
  topSelector: props.topSelector,
  bottomSelector: props.bottomSelector,
});
...
onMounted(() => {
  observer = new ResizeObserver(() => initEars());
