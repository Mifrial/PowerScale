...
const mockUsers: MockUser[] = [
  ...
  { id: 2, name: 'Администратор', login: 'admin', email: 'admin@test.com', password: 'test', groups: ['Администраторы', 'Игрок'], registered: '01.01.2025', active: true, lastLogin: '28.07.2026 09:00', super_admin: true },
