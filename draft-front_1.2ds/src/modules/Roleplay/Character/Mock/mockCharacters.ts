...
export const versions: Record<number, CharacterVersion> = {
  1: {
    ...
    characteristics: [
      ...
      { ruleId: 'rule-48', base: dim(4), modifiers: [] },
      {
        ruleId: 'rule-49',
        base: dim(3, -1),
        modifiers: [{ sourceRuleId: 'rule-21', sourceLabel: null, delta: 1, target: 'melee-combat', scope: null }],
      },
    ],
    resources: [
    ...
    abilities: [
      { ruleId: 'rule-21', level: 1 },
      { ruleId: 'rule-52', level: 1 },
      { ruleId: 'rule-53', level: 1 },
      { ruleId: 'rule-4', level: 1 },
      { ruleId: 'rule-25', level: 1 },
      { ruleId: 'rule-70', level: 1 },
      { ruleId: 'rule-33', level: 1 },
      { ruleId: 'rule-34', level: 1 },
    ],
  ...
  4: {
    ...
    abilities: [{ ruleId: 'rule-21', level: 2 }],
