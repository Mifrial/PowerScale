 ...
 */
export function characterSheetValidationIssues(
  ...
  for (const unmet of unmetAbilityRequirements(model)) {
...
function unmetAbilityRequirements(model: CharacterEditorModel): { name: string; reason: string | null }[] {
