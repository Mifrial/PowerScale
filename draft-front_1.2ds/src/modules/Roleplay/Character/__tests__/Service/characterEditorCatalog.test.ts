...
const keywords: Keyword[] = [
  { id: 20, code: 'common', name: 'Общая', description: '', active: true },
  { id: 31, code: 'racial', name: 'Расовая', description: '', active: true },
  { id: 21, code: 'human', name: 'Человек', description: '', active: true },
  { id: 44, code: 'innate', name: 'Врождённая', description: '', active: true },
  { id: 45, code: 'characteristic', name: 'Характеристика', description: '', active: true },
  { id: 46, code: 'modifier', name: 'Модификатор', description: '', active: true },
  { id: 47, code: 'gift', name: 'Дар', description: '', active: true },
  { id: 50, code: 'wealth', name: 'Богатство', description: '', active: true },
  { id: 48, code: 'sociability', name: 'Общительность', description: '', active: true },
  { id: 49, code: 'attentiveness', name: 'Внимательность', description: '', active: true },
  { id: 51, code: 'memory', name: 'Память', description: '', active: true },
  { id: 52, code: 'insight', name: 'Проницательность', description: '', active: true },
  { id: 53, code: 'reaction', name: 'Реакция', description: '', active: true },
  { id: 54, code: 'maneuver', name: 'Манёвр', description: '', active: true },
  { id: 56, code: 'method-perception', name: 'Метод развития восприятия', description: '', active: true },
  { id: 57, code: 'method-intellect', name: 'Метод развития интеллекта', description: '', active: true },
  { id: 58, code: 'method-communication', name: 'Метод развития общения', description: '', active: true },
  { id: 59, code: 'section-medicine', name: 'Медицина', description: '', active: true },
  { id: 64, code: 'section-melee', name: 'Ближний бой', description: '', active: true },
  { id: 68, code: 'throwing', name: 'Метание', description: '', active: true },
];
