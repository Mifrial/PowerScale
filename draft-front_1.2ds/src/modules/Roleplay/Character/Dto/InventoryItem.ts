/**
 * Предмет в инвентаре персонажа. `ruleCode` — предмет из правил; **null — кастомный
...
export interface InventoryItem {
  ...
  note?: string | null;
  /** Имя кастомного предмета (ruleCode null); для rule-предмета берётся имя правила. */
  name?: string | null;
  /** Описание кастомного предмета (ruleCode null). */
