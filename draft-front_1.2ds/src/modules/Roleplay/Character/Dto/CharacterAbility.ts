...
export interface CharacterAbility {
  ...
  /**
   * Материализованная запись способности-дара (D100) ради хранения домена: уровень вычисляется
   * из гранта, запись не списывает бюджет (buildBudgets пропускает gifted-записи).
   */
  gifted?: boolean;
}
