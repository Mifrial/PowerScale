...
export const SHOCK_STATE_CODE = 'shock';
export const ELECTROCHARGE_STATE_CODE = 'electrocharge';
export const CORE_MAGIC_DEVIATION_STATE_CODE = 'core-magic-deviation';
...
export const LYING_STATE_CODE = 'lying';
export const UNSTABLE_STATE_CODE = 'unstable';
