...
export const mockRaceImport: Rule[] = [
  ...
  raceRule(
    'turim',
    'Турим',
    'Дворф: Стойкость 4, Выносливость 5, бесплатно Пиворождённый/Маленький шаг/Ночное зрение, доступно врождённое магическое ядро.',
    'dwarves',
    0,
    { endurance: { base: 5 } },
    [17, 32, 34],
  ...
  raceRule(
    'orgul',
    'Оргул',
    'Орк: Сила 3↑, Стойкость 3↑, Ловкость 3↓, Интеллект 5↓, бесплатно Бугай/Быстроногий/Сопротивление магии, доступно врождённое магическое ядро.',
    'orcs',
    2,
    {
  ...
  ...rule,
  contentNote: rule.contentNote ?? 'Расовые карточки пока не перепроверены редакционно.',
}));
