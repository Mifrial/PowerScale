...
const importedRules: Rule[] = [
  ...
  personalityRule(
    'bookworm',
    'Книжный червь',
    'На создании: бесплатный экземпляр знания (тип и слоты выбирает игрок) или письменности выбранных знаков. Не речь и не грамотность.',
    1,
    {
      grants: [
        {
      ...
      contentNote: 'Стресса нет. Иероглифы — только первый уровень лестницы 1/1/1.',
    },
  ),
