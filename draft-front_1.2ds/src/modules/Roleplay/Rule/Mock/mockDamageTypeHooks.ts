...
export const mockDamageTypeHooks: Rule[] = [
  hookRule(
    ...
    DT_INJURY_EXTRA_DICE_SR_CODE,
    'Доп. кубы увечья от РУ',
    'На проверке увечья от колющего: ещё [РУ атаки / 2] кубов (РУ уже после оплаты X).',
    8,
  ),
  hookRule(
    'rule-dt-injury-efficiency',
    DT_INJURY_EFFICIENCY_CODE,
    'Эффективность увечья −1',
    'Эффективность проверки на увечье снижена на 1 (обычно до 1, увечья на 2–6).',
    9,
  ...
  hookRule(
    ...
    DT_PAY_SR_VS_RELIABILITY_CODE,
    'Оплата РУ против надёжности',
    'Атакующий выбирает X ≥ 0: платит X РУ атаки и игнорирует всё с надёжностью ≤ X.',
    10,
  ),
  hookRule(
