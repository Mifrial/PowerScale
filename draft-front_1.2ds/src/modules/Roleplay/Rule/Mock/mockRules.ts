...
const rules: Rule[] = [
  ...
  },
  {
    ...
    name: 'Бросок',
    description:
      'Выберите оружие и профиль броска. Мастерство дальнего боя; Ловкость/Восприятие как у удара. Дистанция в ипари обязательна. Игнор: соло против [1+укрытие]↓ (укрытие 0 — 1↓); размер сложности растёт, если дистанция не укладывается в дальнобойность, затем в дальнобойность↑ и далее. Уклон — joint, мастерство дальнего. Блок — только щит. Сила броска падает на размер за каждые [дальнобойность] ипари сверх дистанции оружия; урон и пробитие считаются от этой силы.',
    spaceId: 1,
    keywordIds: [],
    mechanicId: 16,
    mechanic_payload: null,
  ...
  },
  {
    ...
    name: 'Выстрел',
    description:
      'Выберите оружие и профиль выстрела. Мастерство дальнего боя; Ловкость/Восприятие как у удара. Дистанция в ипари обязательна. Игнор: соло против [1+укрытие]↓ (укрытие 0 — 1↓); размер сложности растёт, если дистанция не укладывается в дальнобойность, затем в дальнобойность↑ и далее. Уклон — joint, мастерство дальнего. Блок — только щит. Сила выстрела падает на размер за каждые [дальнобойность] ипари сверх дистанции оружия; урон и пробитие считаются от этой силы.',
    spaceId: 1,
    keywordIds: [],
    mechanicId: 17,
    mechanic_payload: null,
