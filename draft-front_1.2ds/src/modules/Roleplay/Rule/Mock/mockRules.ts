...
const rules: Rule[] = new MockRuleCatalogMigrationService().migrateRules(
  importedRuleNameService.sanitizeCatalog([
    ...
    ...mockEthnicities,
    {
      ...
      type: 'ability',
      name: 'Ожидание',
      description: 'Потратить выбранное количество Очков Действий, не выполняя другого действия.',
      spaceId: 1,
      spec: {
        type: 'action',
    ...
    },
    {
      ...
      spec: {
        ...
        operations: [{ type: 'turn', maxDegrees: 180 }],
        parent_ability_code: null,
      },
      keywordIds: [14, 53],
      mechanicId: null,
    ...
    },
    {
      ...
      description: 'Перемещение на расстояние до одного собственного шага в любом направлении.',
      spaceId: 1,
      spec: {
        type: 'action',
        zones: { or: { kind: 'automatic' } },
        ...
        operations: [
          {
            type: 'movement',
            allowedDirections: { horizontal: ['front', 'flank', 'rear'], vertical: [] },
            distance: {
              horizontal: {
            ...
            freeTurn: { maxDegrees: 90, free: true },
          },
        ],
        parent_ability_code: null,
      },
    ...
    },
    {
      ...
      type: 'ability',
      name: 'Ходьба',
      description: 'Перемещение вперёд на расстояние до одного собственного шага.',
      spaceId: 1,
      spec: {
        type: 'action',
        zones: { or: { kind: 'automatic' } },
    ...
    },
    {
      ...
      type: 'ability',
      name: 'Прыжок',
      description: 'Прыжок по горизонтали и/или вверх с точной компонентной дистанцией.',
      spaceId: 1,
      spec: {
        type: 'action',
        zones: { or: { kind: 'automatic' } },
        ...
        operations: [
          {
            type: 'movement',
            allowedDirections: { horizontal: ['front', 'flank', 'rear'], vertical: ['up'] },
            distance: {
              horizontal: {
                min: { type: 'steps', count: 0 },
                max: { type: 'current_movement_step', multiplier: 1 },
    ...
    },
    {
      ...
      description: 'Изменить положение стоя/лёжа.',
      spaceId: 1,
      spec: {
        type: 'action',
        zones: { or: { kind: 'automatic' } },
        ...
        grants: [],
        action_components: [{ type: 'resource', resource_code: 'action-points', amount: 3, label: 'Действие' }],
        operations: [{ type: 'posture', posture: 'standing_or_prone' }],
        parent_ability_code: null,
      },
      keywordIds: [],
      mechanicId: null,
    ...
    },
    {
      ...
      type: 'ability',
      name: 'Восстановить устойчивость',
      description: 'Снять Неустойчивость, потратив 2 ОД.',
      spaceId: 1,
      spec: {
        type: 'action',
        zones: { or: { kind: 'automatic' } },
    ...
    },
    {
      ...
      spec: {
        ...
        push: {
          pool: 'strength',
          damage: 'crush_from_strength',
          profiles: 'hands_or_shield',
        },
      },
      keywordIds: [14, 71, 1],
      mechanicId: null,
    ...
    },
    {
      ...
      type: 'ability',
      name: 'Бег',
      description: 'Процесс движения вперёд с расходом по одному ОД за часть.',
      spaceId: 1,
      spec: {
        type: 'process',
        zones: { or: { kind: 'automatic' } },
        ...
        process: {
          steps: [
            ...
            {
              code: 'run-continue',
              name: 'Продолжение бега',
              description: 'Следующая часть бега.',
              costs: [{ resource_code: 'action-points', amount: 1 }],
              interruption: { mode: 'normal' },
              operations: [],
            },
          ],
          transition: { mode: 'chain', max_shift: 1, direction: 'forward' },
        },
      },
      keywordIds: [],
      mechanicId: null,
    ...
    },
    {
      ...
      type: 'ability',
      name: 'Спринт',
      description: 'Процесс быстрого движения вперёд после достаточной текущей скорости.',
      spaceId: 1,
      spec: {
        type: 'process',
        zones: { or: { kind: 'automatic' } },
        requirements: [
          {
            level: 1,
            requirements: [
              { type: 'current_speed', axis: 'horizontal', direction: 'front', min_steps_per_action_point: 2 },
            ],
          },
        ],
        grants: [],
        ...
        process: {
          steps: [
              ...
              operations: [
                {
                  ...
                  distance: {
                    horizontal: {
                      min: { type: 'current_movement_step', multiplier: 2 },
                      max: {
                        type: 'size_gap_times_step',
                        characteristic_code_from: 'strength',
                        characteristic_code_to: 'weight',
            ...
            {
              code: 'sprint-continue',
              name: 'Продолжение спринта',
              description: 'Следующая часть спринта.',
              costs: [{ resource_code: 'action-points', amount: 1 }],
              interruption: { mode: 'normal' },
              operations: [],
            },
    ...
    },
    {
      ...
      spec: {
        ...
        limit: {
          ...
          adjustments: [
            {
              value: { type: 'characteristic_size', characteristic_code: 'dexterity' },
              source_code: 'dexterity_source',
            },
            {
    ...
    },
    {
      ...
      name: 'Слабость',
      description:
        'Персонаж ослаблен: −1 к лимиту ОД. Один из исходов группы «Упадок сил» (проверка Воли на истощение).',
      spaceId: 1,
      spec: {
    ...
    },
    {
      ...
      code: 'lying',
      type: 'state',
      name: 'Лежачее положение',
      description: 'Персонаж лежит. Ловкость уменьшена на 6 от состояния. Снимает Неустойчивость.',
      spaceId: 1,
      spec: {
        icon_code: 'mdi-bed',
        value_type: 'flag',
        aggregation: 'max',
        action_codes: ['stand-up'],
    ...
    },
    {
      ...
      name: 'Неустойчивость',
      description:
        'Суммирующаяся сила. До 3 помех на попадание в обе стороны. Снимается действием «Восстановить устойчивость» или лежачим положением.',
      spaceId: 1,
      spec: {
        icon_code: 'mdi-windsock',
        value_type: 'number',
        aggregation: 'sum',
        action_codes: ['recover-stability'],
