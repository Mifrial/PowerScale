...
const mechanics: Mechanic[] = [
  ...
  },
  {
    ...
    name: 'Увечье',
    description:
      'Процедура проверки на увечье. По каждому типу: ⌊повреждения / Стойкость⌋ проверок с хуками типа; нераспределённые остатки разных типов складываются — ещё ⌊сумма остатков / Стойкость⌋ от Упадка сил. Иначе max(повреждения, рана/2, истощение).',
    version: '1.0.0',
  },
  {
    id: 16,
