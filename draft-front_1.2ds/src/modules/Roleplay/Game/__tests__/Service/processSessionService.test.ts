...
const movement: ProcessSpec = {
  ...
  steps: [
    ...
    { code: 'run', name: 'Бег', description: '', costs: [{ resource_code: 'action-points', amount: 2 }] },
    { code: 'sprint', name: 'Спринт', description: '', costs: [{ resource_code: 'action-points', amount: 3 }] },
  ],
};
