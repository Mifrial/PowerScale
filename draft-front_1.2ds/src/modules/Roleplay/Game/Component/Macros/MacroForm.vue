...
<template>
  <div class="macro-form mt-2">
    ...
    <v-text-field v-model="textTemplate" label="Текст сообщения (опционально)" density="compact" variant="outlined" hide-details class="mb-2" />
    ...
    <div class="macro-preview mb-2">
      ...
      <span v-if="!textTemplate.trim() && !rolls.length" class="text-caption text-medium-emphasis">макрос пуст — задайте текст или добавьте бросок</span>
    </div>
