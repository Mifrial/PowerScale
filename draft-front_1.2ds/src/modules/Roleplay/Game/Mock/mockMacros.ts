...
const delay = (ms = 50, signal?: AbortSignal) => new Promise<void>((resolve, reject) => {
...
const macrosByUser: Record<number, UserMacro[]> = {
  1: [
    { id: 1, userId: 1, name: 'Атака мечом', textTemplate: 'Атакую мечом', rolls: [{ rollFormula: '5d6', efficiency: 3, adv: 1, dieSize: 0, rollLabel: 'Удар 1', variableAdvantages: false }], createdAt: '2026-07-25T10:00:00' },
    { id: 2, userId: 1, name: 'Проверка силы', textTemplate: 'Проверка силы', rolls: [{ rollFormula: '4d6', efficiency: 3, adv: 0, dieSize: 1, rollLabel: 'Проверка силы', variableAdvantages: true }], createdAt: '2026-07-25T10:05:00' },
    { id: 3, userId: 1, name: 'Полная атака', textTemplate: 'Атакую дважды', rolls: [
