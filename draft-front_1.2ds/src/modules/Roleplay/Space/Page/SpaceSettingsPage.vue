...
<template>
  <v-container v-if="space">
    ...
    <v-card class="mb-4">
      ...
      <v-card-text>
        <div class="text-body-2 text-medium-emphasis">Управление модераторами будет реализовано позже</div>
      </v-card-text>
    </v-card>
    ...
    <v-card class="mb-4">
      ...
      <v-card-text>
        <div class="text-body-2 text-medium-emphasis">Управление правами доступа будет реализовано позже</div>
      </v-card-text>
    </v-card>
    ...
    <v-dialog v-model="showDeactivateDialog" max-width="400">
      <v-card>
        ...
        <v-card-text> Пространство «{{ space.name }}» будет скрыто из списков, данные сохранятся. </v-card-text>
        <v-card-actions>
          <v-spacer />
